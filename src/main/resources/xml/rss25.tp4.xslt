		...
		<html>
			...
			<body>
				...
				<ul>
					...
					<li>publié le <xsl:value-of select="format-date(xs:date(substring-before(rss:pubDate, 'T')), '[D] [MNn] [Y]')"/>
					</li>
					<li>copyright <xsl:value-of select="rss:copyright"/>
					</li>
				</ul>
                ...
                <table border="1">
                    ...
                    <tbody>
                        ...
                        <xsl:for-each select="rss:item">
                            <xsl:sort select="rss:published| rss:updated" data-type="text" order="descending"/>
                            ...
                            <tr class="{rss:category/@term}">
                                ...
                                <!-- Titre de la rubrique, tronqué à 45 caractères si nécessaire -->
                                <td>
                                    <xsl:choose>
                                ...
                                <td>
                                    <xsl:value-of select="rss:published | rss:updated"/>
                                </td>
				...
				<xsl:for-each select="rss:item">
					...
					<xsl:if test="rss:image">
						...
						<div><img src="{rss:image/@href}" alt="{rss:image/@alt}" width="500" height="300"/></div>
					</xsl:if>
                    ...
                    <xsl:value-of select="format-date(xs:date(substring-before(rss:updated, 'T')), '[Y]')"/></p>
					</xsl:if>
